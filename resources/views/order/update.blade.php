                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="jenis_order" name="jenis_order" value="{{$edit->jenis_order}}">
                                </div>
                                <div class="mb-3">
                                    <label for="jumlah_produk" class="form-label">Jumlah Produk</label>
                                    <input type="text" class="form-control" id="jumlah_produk" name="jumlah_produk" value="{{$edit->jumlah_produk}}">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="total_harga" name="total_harga" value="{{$edit->total_harga}}">
                                </div>
